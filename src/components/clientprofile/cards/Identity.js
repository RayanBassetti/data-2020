            ...
            <CardContent className="card_top_content flexed-row">
                ...
                <div className="ctc_right fullwidth">
                    ...
                    <div className="ctc_right_subpart">
                        <div className="flexed-row-space"><span className="bold_title">Satisfaction</span><ProgressBar width={satisfaction}/></div>
                        <div className="flexed-row-space"><span className="bold_title">Relation</span><ProgressBar width={relation}/></div>
                    </div>
                </div>
            </CardContent>
        </Card>
